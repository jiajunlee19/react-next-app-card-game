...
export default function NgaoCalculatorComponent({ digitValuePairs, initialCardCounter }: TNgaoCalculatorComponent) {
    ...
    return (
        <div className="flex flex-col gap-8 my-4">
            ...
            <button className="btn-primary w-fit" onClick={() => handleReset()}>Calculate</button>
            {cardSelectors.map((cardSelector) => {
                return (
                    <select className="w-fit" key={cardSelector.cardNumber} value={cardSelector.card || ""} onChange={handleCardSelect(cardSelector.cardNumber as "c1" | "c2" | "c3" | "c4" | "c5")}>
